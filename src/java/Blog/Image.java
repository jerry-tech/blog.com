...
public class Image extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String fname = request.getParameter("fname");//getting the username of the image uploader for unique identification
        ...
        if (!"".equals(fileName)) {
            ...
            String regno = request.getParameter("idd");//getting the reg no of the image uploader
            ...
            try {
                ...
                try (Connection con = DriverManager.getConnection("jdbc:sqlserver://localhost;databaseName=myBlog_com;user=sa;password=123456");) {
                    ...
                    try (PreparedStatement ps = con.prepareStatement("insert into users.userimg values(?,?,?)");) {
